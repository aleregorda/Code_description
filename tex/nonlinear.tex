...
\begin{eqnarray}\label{eq:viscous}
...
\begin{eqnarray}\label{eq:visco_creep}
...
obtaining
\begin{eqnarray}\label{eq:plastic}
...
\begin{eqnarray}\label{eq:viscoplastic}
...
\begin{eqnarray}\label{eq:convergence}
...
\begin{eqnarray}\label{eq:convergence_res}
...
calculated as
\begin{eqnarray}\label{eq:convergence_vel}
\frac{||\Delta\bm{v}||_2}{||\bm{v}||_2}=\frac{||\bm{v}_i-\bm{v}_{i-1}||_2}{||\bm{v}_{i}||_2}
\end{eqnarray}
and
\begin{eqnarray}\label{eq:convergence_press}
