...
%\includegraphics[width=5cm]{./Figures/Zalesak.pdf}
...
%The clockwise rotation of the disk at $t=0.25$, 0.5 and 0.75 is shown in Fig. \ref{fig:runge} (red, blue and green, respectively).
