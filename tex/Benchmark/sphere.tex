...
initially centred at ($0.5;0.6$) with radius $R=0.123456789$.
\begin{wrapfigure}{l}{11.5cm}
\includegraphics[width=11.5cm]{./Figures/vrms_arithm.pdf}
...
\end{wrapfigure}
The fluid surrounding the sphere has $\rho_f=1$ and $\eta_f=1$ and occupies the domain for
...
\url{https://github.com/aleregorda/Benchmarks/tree/main/Surface_processes/Time_dependent_sphere}. Results in terms of the root-mean-square velocity $v_{\textrm{rms}}$ (as in Eq. \ref{vrms}) in case of an arithmetic average are also shown in Fig. \ref{fig:inst_spherefs}.